...
public class SparkSqlCondition extends BaseBuilder {
     ...
     * 字段名与中文名对应关系
     */
    private Map<String, String> fieldAliasAndDescMap = Maps.newLinkedHashMap();
     ...
     * 取后n条时的反向排序
     */
    private Map<String, String> reverseByMap = Maps.newLinkedHashMap();
    ...
    public void setFieldAliasAndDescMap( Map<String, String> fieldAliasAndDescMap ) {
        this.fieldAliasAndDescMap = fieldAliasAndDescMap;
    }

    public Map<String, String> getReverseByMap() {
        return reverseByMap;
    }

    public void setReverseByMap( Map<String, String> reverseByMap ) {
        this.reverseByMap = reverseByMap;
    }
}
