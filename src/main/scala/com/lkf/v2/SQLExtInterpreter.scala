...
import com.lkf.demo._
import org.apache.livy.client.ext.model.v2.Constant.PIVOT_ALIAS
import org.apache.livy.client.ext.model.v2.{Constant, QoqDTO, SparkSqlBuild, SparkSqlCondition}
...
object SQLExtInterpreter {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //同环比
    val param = "{\"compareCondition\":[{\"aliasName\":\"集团名称\",\"dataType\":\"str\",\"fieldDescription\":\"集团名称\",\"fieldGroup\":0,\"fieldId\":\"180620140418000825\",\"fieldName\":\"group_name\",\"fieldAliasName\":\"ljc_compare_0_group_name_0\",\"isBuildAggregated\":0,\"udfType\":0,\"uniqId\":\"1534408923000\"}],\"dataSourceType\":0,\"dbName\":\"cy7_2\",\"dimensionCondition\":[{\"aliasName\":\"门店名称\",\"dataType\":\"str\",\"fieldDescription\":\"门店名称\",\"fieldGroup\":0,\"fieldId\":\"180620140418000824\",\"fieldName\":\"store_name\",\"fieldAliasName\":\"ljc_group_0_store_name_0\",\"isBuildAggregated\":0,\"udfType\":0,\"uniqId\":\"1534227767000\"},{\"aliasName\":\"营业日\",\"dataType\":\"datetime\",\"fieldDescription\":\"营业日\",\"fieldGroup\":0,\"fieldId\":\"180620140417000718\",\"fieldName\":\"settle_biz_date\",\"fieldAliasName\":\"ljc_group_0_settle_biz_date_1\",\"isBuildAggregated\":0,\"udfType\":0,\"uniqId\":\"1534227854000\"}],\"filterCondition\":[{\"dataType\":\"str\",\"fieldDescription\":\"集团\",\"fieldGroup\":0,\"fieldName\":\"group_code\",\"fieldValue\":[\"9759\"],\"isBuildAggregated\":0,\"udfType\":0}],\"indexCondition\":[{\"aggregator\":\"sum\",\"aggregatorName\":\"求和\",\"aliasName\":\"营业额（应收）(求和)\",\"dataType\":\"double\",\"fieldDescription\":\"营业额（应收）\",\"fieldGroup\":0,\"fieldId\":\"180620140418000772\",\"fieldName\":\"recv_money\",\"fieldAliasName\":\"ljc_sum_0_recv_money_0\",\"isBuildAggregated\":0,\"qoqType\":0,\"udfType\":0,\"uniqId\":\"1534227775000\"},{\"aggregator\":\"count\",\"aggregatorName\":\"计数\",\"aliasName\":\"就餐人数(计数)\",\"dataType\":\"int\",\"fieldDescription\":\"就餐人数\",\"fieldGroup\":0,\"fieldId\":\"180620140417000705\",\"fieldName\":\"people_qty\",\"fieldAliasName\":\"ljc_count_0_people_qty_1\",\"isBuildAggregated\":0,\"qoqType\":0,\"udfType\":0,\"uniqId\":\"1534410737000\"},{\"aggregator\":\"sum\",\"aggregatorName\":\"求和\",\"aliasName\":\"实际收入（实收）(求和)\",\"dataType\":\"double\",\"fieldDescription\":\"实际收入（实收）\",\"fieldGroup\":0,\"fieldId\":\"180620140418000779\",\"fieldName\":\"real_income\",\"fieldAliasName\":\"ljc_sum_0_real_income_2\",\"isBuildAggregated\":0,\"qoqType\":0,\"udfType\":0,\"uniqId\":\"1534493887000\"}],\"limit\":1000,\"page\":0,\"queryPoint\":0,\"queryType\":0,\"reportCode\":\"180814092350004003\",\"sessionId\":\"3\",\"sortCondition\":[{\"dataType\":\"\",\"fieldDescription\":\"\",\"fieldGroup\":0,\"fieldId\":\"\",\"fieldName\":\"营业额（应收）(求和):%重庆李子坝餐饮总部\",\"fieldAliasName\":\"营业额（应收）(求和):%重庆李子坝餐饮总部\",\"isBuildAggregated\":0,\"sortFlag\":\"desc\",\"sortType\":1,\"udfType\":0}],\"sparkConfig\":{\"spark.executor.memory\":\"7273m\",\"spark.driver.memory\":\"7273m\",\"spark.driver.cores\":\"2\",\"spark.cassandra.connection.host\":\"192.168.12.33,192.168.12.203,192.168.12.204\",\"spark.custom.coalesce\":\"4\",\"spark.executor.cores\":\"2\",\"spark.sql.shuffle.partitions\":\"5\",\"spark.cassandra.connection.port\":\"9042\",\"spark.default.parallelism\":\"8\",\"spark.scheduler.mode\":\"FAIR\",\"spark.executor.instances\":\"3\"},\"tbId\":\"180620140417000008\",\"tbName\":\"dw_trade_bill_fact_p_group\",\"tracId\":\"1535426445000\"}"
    ...
    try {
      ...
      //
      //      // Get the row data
      //      val rows = df.take(1000).map(_.toSeq)
      //      val jRows = Extraction.decompose(rows)
      //
      //
      //      val map = Map("schema" -> jSchema, "data" -> jRows)
      //
      //      println(map)
  ...
  private[this] def parseResult(result: DataFrame, sparkSqlCondition: SparkSqlCondition, totalNum: Long): ResponseResult = {
    ...
    //查询项字段与中文名对应关系
    val fieldMap: util.Map[String, String] = sparkSqlCondition.getFieldAliasAndDescMap
